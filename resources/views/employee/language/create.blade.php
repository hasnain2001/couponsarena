...
<div class="content-wrapper">
    ...
    @endif
            <form name="Createlanguage" id="Createlanguage" method="POST" action="{{ route('employee.lang.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="card">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ route('employee.lang.lang') }}" class="btn btn-secondary">Cancel</a>
