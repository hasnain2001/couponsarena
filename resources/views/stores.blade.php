...
<a href="{{ $storeurl }}" class="card-link text-decoration-none">
                ...
                <div class="shadow-bg h-100">
                    <div class="card-body text-center">
                        <img class="stores-img  shadow" src="{{ $store->store_image ? asset('uploads/stores/' . $store->store_image) : asset('front/assets/images/no-image-found.jpg') }}" loading="lazy" alt="Card Image">
